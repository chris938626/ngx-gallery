...
export class NgxGalleryPreviewComponent implements OnChanges {
    ...
    canDragOnZoom() {
        return (this.previewFullSize===true) || (this.zoom && this.zoomValue > 1);
    }
